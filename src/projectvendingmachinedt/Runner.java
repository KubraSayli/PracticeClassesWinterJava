...
public class Runner {
	...
	/*
	 * Positive Scenario: User should be able to buy a single product User should be
	 * able to buy multiple products
	 * 
	 * Negative Scenario: User should be able to buy if the balance is not enough
	 * (add/no add)
	 */
